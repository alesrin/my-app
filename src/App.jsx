...
function App() {
  ...
  const concatenado = 'Hola me llamo' + nombre + 'y tengo' + usuario.edad + 'años'
  ...
  const saludo_template = `Hola, ${name.toUpperCase()}, el precio del producto + IVA es ${calcularPrecioConIva(productoSeleccionado)}`
